# Generated by Django 3.1.1 on 2021-09-08 14:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(related_name='topic_users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('status', models.CharField(choices=[('OP', 'Open'), ('CL', 'Closed'), ('PE', 'Pending'), ('RE', 'Resolved')], default='OP', max_length=2)),
                ('content', models.TextField()),
